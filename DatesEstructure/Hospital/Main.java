        ...
        do {
            ...
            switch (OpcSelec) { ///registrar paciente
                case 0:
                    ...
                    while (true) {
                        String idD = JOptionPane.showInputDialog(null, "Ingrese el ID del doctor:", "Registro de doctor", JOptionPane.PLAIN_MESSAGE);
                        if (idD != null && !idD.trim().isEmpty()) {
                            String nombreD = JOptionPane.showInputDialog(null, "Ingrese el nombre del doctor:", "Registro de doctor", JOptionPane.PLAIN_MESSAGE);
                            if (nombreD != null && !nombreD.trim().isEmpty()) {
                                String apellidoD = JOptionPane.showInputDialog(null, "Ingrese el apellido del doctor:", "Registro de doctor", JOptionPane.PLAIN_MESSAGE);
                                if (apellidoD != null && !apellidoD.trim().isEmpty()) {
                                    String especialidad = JOptionPane.showInputDialog(null, "Ingrese la especialidad:", "Registro de doctor", JOptionPane.PLAIN_MESSAGE);
                                    if (especialidad != null) {
                                        String telefonoD = JOptionPane.showInputDialog(null, "Ingrese el teléfono del doctor:", "Registro de doctor", JOptionPane.PLAIN_MESSAGE);
                                        if (telefonoD != null) {
                                            doc = new Doctor(idD, nombreD, apellidoD, especialidad, telefonoD);
                                            JOptionPane.showMessageDialog(null, "Doctor con ID " + idD + " registrado exitosamente.", "Registro Exitoso", JOptionPane.INFORMATION_MESSAGE);
                                            break;
                                        }
                                    }
                                } else if (apellidoD != null) {
                                    JOptionPane.showMessageDialog(null, "El apellido no puede estar vacío.", "Error", JOptionPane.ERROR_MESSAGE);
                                }
                            } else if (nombreD != null) {
                                JOptionPane.showMessageDialog(null, "El nombre no puede estar vacío.", "Error", JOptionPane.ERROR_MESSAGE);
                            }
                        } else if (idD != null) {
                            JOptionPane.showMessageDialog(null, "La ID no puede estar vacio", "ERROR", JOptionPane.ERROR_MESSAGE);
                        }
                    }
                    while (true) {
